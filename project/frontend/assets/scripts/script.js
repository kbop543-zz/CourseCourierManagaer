$(document).ready(function(){
    ...
    $('#login').click(function () {
        $("main").empty();
        $("main").append('<form action="/actiononfile"> Username: <input type="text" name="Username"><br> Password: <input type="text" name="Password"><br><input type="submit" value="Log In"><input type="reset" value="Reset"><br></form>');
    });
