...
public class CalendarJsonServlet extends HttpServlet
{
	...
	public void createCalendar()
	{
		...
		markableList.add( new MarkableImpl( 
			"A1", "10%", "2017-01-26T16:00:00Z", "2017-01-26T17:00:00Z", "Not applicable") );
		markableList.add( new MarkableImpl( 
			"A2", "15%", "2017-02-16T16:00:00Z", "2017-02-16T17:00:00Z", "Not applicable") );
		markableList.add( new MarkableImpl( 
			"A3", "20%", "2017-02-28T16:00:00Z", "2017-02-28T17:00:00Z", "Not applicable") );
		markableList.add( new MarkableImpl( 
			"Midterm", "25%", "2017-03-17T16:00:00Z","2017-03-17T18:00:00Z", "EX100") );
		markableList.add( new MarkableImpl( 
			"Exam", "30%", "2017-04-02T18:00:00Z", "2017-04-02T21:00:00Z", "EX200") );
